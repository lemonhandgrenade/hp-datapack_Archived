...
scoreboard players operation #x values *= #temp values

#Teleports the player 1 block{block_state:"minecraft:if"} it needs, this is all just binary
scoreboard players operation @s values = #x values
